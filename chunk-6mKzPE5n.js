import {p as pe,l as le}from'./chunk-CcSGHh98.js';import {$ as $t,H as Ht,f as fe}from'./chunk-6vewtQGV.js';import {Z,a8 as dt,ag as cr,a3 as ue,aM as Ne,bg as Ae,b9 as So,a4 as Xe,v as ei,ad as to,ak as eb,ab as ca,a5 as an,bw as yi,bx as Xg,G as G_,Q as Qy,aL as Xy,p as pv,k as iv,H as Iv}from'./main-JEN4YWZW.js';function j(i,m){}var F="_mat-bottom-sheet-enter",L="_mat-bottom-sheet-exit",z=(()=>{class i extends le{_breakpointSubscription;_animationsDisabled=cr();_animationState="void";_animationStateChanged=new an;_destroyed=false;constructor(){super();let e=Z(yi);this._breakpointSubscription=e.observe([Xg.Medium,Xg.Large,Xg.XLarge]).subscribe(()=>{let n=this._elementRef.nativeElement.classList;n.toggle("mat-bottom-sheet-container-medium",e.isMatched(Xg.Medium)),n.toggle("mat-bottom-sheet-container-large",e.isMatched(Xg.Large)),n.toggle("mat-bottom-sheet-container-xlarge",e.isMatched(Xg.XLarge));});}enter(){this._destroyed||(this._animationState="visible",this._changeDetectorRef.markForCheck(),this._changeDetectorRef.detectChanges(),this._animationsDisabled&&this._simulateAnimation(F));}exit(){this._destroyed||(this._elementRef.nativeElement.setAttribute("mat-exit",""),this._animationState="hidden",this._changeDetectorRef.markForCheck(),this._animationsDisabled&&this._simulateAnimation(L));}ngOnDestroy(){super.ngOnDestroy(),this._breakpointSubscription.unsubscribe(),this._destroyed=true;}_simulateAnimation(e){this._ngZone.run(()=>{this._handleAnimationEvent(true,e,this._elementRef.nativeElement),setTimeout(()=>this._handleAnimationEvent(false,e,this._elementRef.nativeElement));});}_trapFocus(){super._trapFocus({preventScroll:true});}_handleAnimationEvent(e,n,t){if(t===this._elementRef.nativeElement){let o=n===F;(o||n===L)&&this._animationStateChanged.emit({toState:o?"visible":"hidden",phase:e?"start":"done"});}}static \u0275fac=function(n){return new(n||i)};static \u0275cmp=G_({type:i,selectors:[["mat-bottom-sheet-container"]],hostAttrs:["tabindex","-1",1,"mat-bottom-sheet-container"],hostVars:9,hostBindings:function(n,t){n&1&&pv("animationstart",function(a){return t._handleAnimationEvent(true,a.animationName,a.target)})("animationend",function(a){return t._handleAnimationEvent(false,a.animationName,a.target)})("animationcancel",function(a){return t._handleAnimationEvent(false,a.animationName,a.target)}),n&2&&(iv("role",t._config.role)("aria-modal",t._config.ariaModal)("aria-label",t._config.ariaLabel),Iv("mat-bottom-sheet-container-animations-enabled",!t._animationsDisabled)("mat-bottom-sheet-container-enter",t._animationState==="visible")("mat-bottom-sheet-container-exit",t._animationState==="hidden"));},features:[Qy],decls:1,vars:0,consts:[["cdkPortalOutlet",""]],template:function(n,t){n&1&&Xy(0,j,0,0,"ng-template",0);},dependencies:[fe],styles:[`@keyframes _mat-bottom-sheet-enter {
  from {
