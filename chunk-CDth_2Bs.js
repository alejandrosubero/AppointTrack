import {l as lt,d,P}from'./chunk-LQXTEhmv.js';import {J as Jt,Y as Yt,Z as Zt$1,n as nt,e as et}from'./chunk-C0ANhSK1.js';import {y as yt,w as wt}from'./chunk-Aq-i--_X.js';import {Q as Q$1,g as Ae,k as mf,l as ia,aN as si,n as Cd,$ as Ht,R as Mo,bm as ss,a0 as _y,ag as de,ax as we,a1 as At,a2 as Zt,a3 as ce,aq as cc,b4 as md,aI as ji,at as DH,F as Iv,j as j_,A as A0,r as ru,X as XT,E as Ef,b as pv,a as aT,u as uC,c as uT,I as IT,_ as _f}from'./main-CMPCBQRE.js';var Y=new ce("MAT_BADGE_CONFIG"),Q="mat-badge-content",ee=(()=>{class n{static \u0275fac=function(t){return new(t||n)};static \u0275cmp=j_({type:n,selectors:[["ng-component"]],decls:0,vars:0,template:function(t,i){},styles:[`.mat-badge {
  position: relative;
}
.mat-badge.mat-badge {
  overflow: visible;
